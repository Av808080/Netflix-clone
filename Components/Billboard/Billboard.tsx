...
const Billboard = () => {
    ...
    // const {data:mpvies , isLoading :load , error:e} = useMovies()
    // console.log({mpvies , e , load});
    ...
    return (
        <section className='text-white relative'>
            ...
            <div className='absolute top-[20%] left-[5%] right-[15%] sm:right-[25%] md:right-[40%] lg:right-[50%] max-h-screen
